...
function showIntegerArray() {
  document.getElementById(
    "result"
  ).innerHTML = `Mảng số nguyên gồm : ${integerArray}`;
}
function showSumPositiveNum() {
  ...
  document.getElementById(
    "result"
  ).innerHTML = ` Tổng số dương trong mảng là: ${positiveNum}`;
}
function showCountPositiveNum() {
  ...
  document.getElementById(
    "result"
  ).innerHTML = `Số lượng số dương trong mảng là: ${countPositiveNum}`;
...
function findMinimumNum() {
  ...
  document.getElementById(
    "result"
  ).innerHTML = `Số nhỏ nhất trong mảng là: ${minimumNum}`;
}
...
function findMinimunPositiveNum() {
  ...
  document.getElementById(
    "result"
  ).innerHTML = `Số dương nhỏ nhất trong mảng là ${mininPositiveNum}`;
}
...
function findLastEvenNum() {
  ...
  document.getElementById(
    "result"
  ).innerHTML = `Số chẵn cuối cùng trong mảng là ${lastEvenNum}`;
}
...
function changePositionNum() {
  ...
  document.getElementById(
    "resultTwo"
  ).innerHTML = `Mảng đã đổi chổ hai vị trí ${integerArrayTest}`;
}
//        !!!            //
function sortArrayNum() {
  ...
  document.getElementById(
    "resultTwo"
  ).innerHTML = `Mảng sắp xếp theo giá trị tăng dần là: ${integerArrayTest}`;
}
...
function findPrimeNum() {
  ...
  document.getElementById(
    "resultTwo"
  ).innerHTML = `Số nguyên tố đầu tiên trong mảng là: ${primeNum}`;
}
...
function addRealNum() {
  ...
  document.getElementById(
    "resultThree"
  ).innerHTML = `Mảng số thực gồm: ${realNumberArray}`;
...
function showRealNum() {
  ...
  document.getElementById(
    "resultThree"
  ).innerHTML = `Số lượng số nguyên trong mảng số thực là: ${countRealNum}`;
}
...
function comparePosAndNegNum() {
  ...
  if (posi > nega) {
    document.getElementById(
      "result"
    ).innerHTML = `Số lượng Số dương nhiều hơn số âm`;
  } else if (posi < nega) {
    document.getElementById(
      "result"
    ).innerHTML = `Số lượng Số dương ít hơn số âm`;
  } else {
    document.getElementById(
      "result"
    ).innerHTML = `Số lượng Số dương bằng số âm`;
  }
}
